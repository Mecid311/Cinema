...
namespace CinemaPro.WebUI.Areas.Admin.Controllers
{
    ...
    public class LanguagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Languages")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Languages")] Language language)
        {
            if (id != language.Id)
            {
                return NotFound();
